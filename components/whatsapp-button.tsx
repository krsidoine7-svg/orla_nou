...
export function WhatsAppButton() {
    ...
    return (
        ...
        >
            ...
            >
                {/* Tooltip */}
                <div className="hidden sm:block absolute left-full ml-3 bg-white px-3 py-1.5 rounded-lg shadow-lg border border-gray-100 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap">
                    <p className="text-sm font-medium text-gray-700">
                        {language === "fr" ? "Discuter sur WhatsApp" : "Chat on WhatsApp"}
                    </p>
                </div>

                <div className="w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 active:scale-95">
                    <svg
                        viewBox="0 0 24 24"
